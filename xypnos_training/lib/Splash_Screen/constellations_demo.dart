...
class ConstellationsListDemo extends StatefulWidget {
  static String routeName = "/ConstellationsListDemo";
  @override
...
class _ConstellationsListDemoState extends State<ConstellationsListDemo>
  ...
  static const double idleSpeed = .4;
  ...
  List<SplashContentData> _splashData;
  @override
  @override
  void initState() {
    _splashData = Shown_Data().getSplashData();
  ...
  Route _buildPageRoute(RouteSettings route) {
    ...
    if (route.name == ConstellationDetailView.route) {
      ...
      page = ConstellationDetailView(
          ...
          contentDelay: starAnimDurationIn + 1500,
    ...
    //Default to ListView as our home route
      ...
      page = ConstellationListView(
        // onScrolledSplashScreen: _handleListScroll,
