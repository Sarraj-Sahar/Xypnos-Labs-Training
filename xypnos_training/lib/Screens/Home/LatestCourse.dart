...
class LatestCourse extends StatefulWidget {
  const LatestCourse(this.latestcourse);
  //
  final Rx<Course> latestcourse;

  @override
  State<LatestCourse> createState() => _LatestCourseState();
}
...
class _LatestCourseState extends State<LatestCourse> {
  ...
  Widget build(BuildContext context) {
    String coursecover;
    if (widget.latestcourse.value.coverImage.toString() != null) {
      coursecover = RemoteServices.cover_image_url +
          widget.latestcourse.value.coverImage.toString();
    } else {
      coursecover = "";
    }
    return Container(
            ...
            Container(
              ...
              child: Image.network(
                RemoteServices.cover_image_url +
                    widget.latestcourse.value.coverImage,
                height: 190,
                fit: BoxFit.cover,
              ),
              ...
              children: [
                Padding(
                  ...
                  child: Text(
                    ...
                    "Intrested In ${widget.latestcourse.value.title} ?",
                    style: TextStyle(
                        letterSpacing: 1.2,
                ...
                Padding(
                  ...
                  child: GestureDetector(
                    onTap: () {
                      Get.to(
                        DetailedCourse(
                            course: widget.latestcourse.value, index: 0),
